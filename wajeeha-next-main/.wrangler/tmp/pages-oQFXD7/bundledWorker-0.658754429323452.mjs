...
var oe = /* @__PURE__ */ __name((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of re(t))
      !ie.call(e, n) && n !== s && q(e, n, { get: () => t[n], enumerable: !(a = se(t, n)) || a.enumerable });
  return e;
}, "oe");
var U = /* @__PURE__ */ __name((e, t, s) => (s = e != null ? ae(ne(e)) : {}, oe(t || !e || !e.__esModule ? q(s, "default", { value: e, enumerable: true }) : s, e)), "U");
var y;
var l = j(() => {
  y = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.658754429323452.mjs.map
